...
<head>
    ...
    <!--[if lt IE 10]>
      ...
      <!-- waves.css -->
      <link rel="stylesheet" href="{{asset('template')}}/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
      ...
      <!-- Font Awesome -->
      <link rel="stylesheet" type="text/css" href="{{asset('template')}}/assets/icon/font-awesome/css/font-awesome.min.css">
      <!-- Style.css -->
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <!-- Authentication card start -->
                        <form action="{{route('cekLogin')}}" method="post" class="md-float-material form-material">
                            @csrf
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    <div class="row m-b-20">
                                        ...
                                        <small>user : ashim, pass : Ashim1</small>
                                    </div>
                                    @if (session('status'))
...
<script type="text/javascript" src="{{asset('template')}}/assets/js/jquery-slimscroll/jquery.slimscroll.js"></script>
