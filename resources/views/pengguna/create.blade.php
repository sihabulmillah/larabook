 ...
 <div class="col-sm-12">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <h5>Add Data Pengguna</h5>
            <span>Larabook <code>store</code></span>
        </div>
        <div class="card-block">
            <form method="post" action="pengguna/store" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <input type="text" name="nama" placeholder="Masukan Nama Anda" value="{{old('nama')}}"  class="form-control
            ...
            <div class="row">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        <input type="password" name="password" placeholder="Masukan Nama password" value="{{old('password')}}"  class="form-control
