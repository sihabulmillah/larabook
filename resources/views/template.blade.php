...
<head>
 ...
 <!-- waves.css -->
 <link rel="stylesheet" href="template/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
 <!-- Required Fremwork -->
 ...
 <!-- font-awesome-n -->
 <link rel="stylesheet" type="text/css" href="template/assets/css/font-awesome-n.min.css">
   ...
   <nav class="navbar header-navbar pcoded-header">
    <div class="navbar-wrapper">
     ...
     <div class="navbar-container container-fluid">
      ...
      <ul class="nav-right">
      <li><a href="{{route('logout')}}"><button class="btn btn-warning btn-sm text-dark" style="font-size: 15px">Logout <i class="fa fa-sign-out"></i></button></a></li>
      </ul>
     </div>
    </div>
   </nav>
      ...
      <div class="pcoded-inner-navbar main-menu">
       <div class="">
        <div class="main-menu-header">
         <img class="img-80 img-radius" src="template/assets/images/sihab.jpg" alt="User-Profile-Image">
         <div class="user-details">
          <span id="more-details">{{Auth::guard('pengguna')->user()->nama}}<i class="fa fa-caret-down"></i></span>
         </div>
        </div>
       ...
       <ul class="pcoded-item pcoded-left-item">
        ...
        <span class="pcoded-mtext">Larabook Menu</span>
        <span class="pcoded-mcaret"></span>
        </a>
        <ul class="pcoded-submenu">
        @if (auth()->user()->level == "a" || auth()->user()->level == "p" || auth()->user()->level == "s")    
        <li class=" ">
        <a href="{{route('book')}}" class="waves-effect waves-dark">
        ...
        @endif
        @if (auth()->user()->level == "a" || auth()->user()->level == "s")
        <li class=" ">
        ...
        <li class="">
         <a href="{{route('pengguna')}}" class="waves-effect waves-dark">
          <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
        ...
        <div class="row align-items-center">
         <div class="col-md-8">
          <div class="page-header-title">
           <h5 class="m-b-10">Dashboard Larabook</h5>
           <p class="m-b-0">Selamat Datang, {{Auth::guard('pengguna')->user()->nama}}</p>
          </div>
         </div>
         <div class="col-md-4">
          <ul class="breadcrumb">
      ...
      <div class="pcoded-inner-content">
       ...
       <div class="main-body">
        <div class="page-wrapper">
         <!-- Page-body start -->
         {{-- yield digunakan untuk membari tanda --}}
         @yield('konten')
         <!-- Page-body end -->
        </div>
...
<![endif]-->
 ...
 <!-- waves js -->
 <script src="template/assets/pages/waves/js/waves.min.js"></script>
 ...
 <script src="template/assets/js/vertical/vertical-layout.min.js "></script>
